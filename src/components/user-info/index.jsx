        ...
        <div className="user-info-container">
            <div className="user-info-desc">
                <p>
                    ...
                    используя самые современные аналитические инструменты. В
                    работе с клиентами недостаточно просто решить конкретную
            ...
            <div className="user-info-contacts">
                <div className="user-info-contact">
                    <img
                        ...
                        alt="Телефон"
                    />
                    <span className="contact-info">+7 (954) 333-44-55</span>
                </div>
                <div className="user-info-contact">
